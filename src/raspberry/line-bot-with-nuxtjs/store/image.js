...
export const mutations = {
  ...
  updateImageBase64(state, imgBase64){
    state.imgBase64 = imgBase64
  },
}

export const actions = {
  requestImg({ commit, state }) {
    ...
    axios
      ...
      .then((response) => {
        commit('updateImageBase64', response.data)
